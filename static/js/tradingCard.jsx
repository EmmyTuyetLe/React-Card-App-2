...
function TradingCardContainer() {
  ...
  function addCard(cardId, name, skill) {
    ...
    const newCard = {cardId, skill, name, imgUrl}; // same as to { cardId: cardId, skill: skill, name: name, imgUrl: imgUrl }
    const currentCards = [...cards]; // spread operator makes a copy of cards. like doing currentCards = cards[:] in Python
